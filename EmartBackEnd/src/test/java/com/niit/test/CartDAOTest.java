...
public class CartDAOTest 
{
	...
	public void addCartItemTest()
	{
		...
		cartItem.setProductName("car");
		cartItem.setPrice(130);
		cartItem.setQuantity(50);
		cartItem.setUsername("bala");
		cartItem.setPstatus("NP");
		assertTrue("could not add to cart:",cartDAO.addCartItem(cartItem));
	}
	...
	{
		List<CartItem> listCartItem = cartDAO.listCartItem("bala");
